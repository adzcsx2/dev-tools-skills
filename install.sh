...
COMMON_SKILLS="init init-root study push execute-loop update-remote-plugins code-note to-public-cloudflare project-skills work-report local-worktree update-docs codex-sync-push codex-sync-pull"
...
category_desc() {
  case "$1" in
    common)  echo "Common tools (dt:init, dt:init-root, dt:study, dt:push, dt:execute-loop, dt:update-remote-plugins, dt:code-note, dt:to-public-cloudflare, dt:project-skills, dt:work-report, dt:update-docs, dt:codex-sync-push, dt:codex-sync-pull)" ;;
