...
argument-hint: "<task-slug> [test] e.g. /dt:plan-doc-tr my-feature"
origin: dev-tools-skills
---

# Plan-Doc-T-R: Plan-Doc + TDD + Code Review (Full Pipeline)
...
## Plan-Doc-T-R Execution Flow

Task: $ARGUMENTS

### === Phase 1 START: Plan-Doc Generation ===

Call `/dt:plan-doc` via Skill tool:

```
Skill tool with skill: "dev-tools-skills:plan-doc", args: $ARGUMENTS
```
...
**Hard check**: The plan-doc skill has TWO confirmation gates:
