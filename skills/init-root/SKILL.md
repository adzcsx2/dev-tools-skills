...
- Preserve its CodeGraph, docs taxonomy, `CLAUDE.md`, `AGENTS.md`, Copilot config, `dt:install-project-hooks` final rule audit hook, review, and `.gitignore` behavior
...
### Step 5. Add Root Git Policy To `AGENTS.md`

Update root `AGENTS.md` with a concise "Multi-Repo Root Git Policy" section:
...
- `AGENTS.md` contains the multi-repo root git policy
