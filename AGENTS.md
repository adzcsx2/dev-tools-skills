...
AI Skills repository for Codex and VS Code Copilot. Provides a collection of reusable skills.
...
- Version and metadata: `.Codex-plugin/plugin.json`
- Skills list: `skills/` directory scan
- Installation logic: `install.sh` / `install.ps1`
- Project rules: `AGENTS.md`, `AGENT.md`, `.github/copilot-instructions.md`
...
3. `.Codex-plugin/marketplace.json` — add `"./skills/<skill-name>"` to the skills array
...
3. `.Codex-plugin/marketplace.json` (if applicable)
