...
此 prompt 对应的主 skill 已拆成“主编排 + references 细则”结构。开始生成任何文件前，先按顺序读取：

1. `skills/init/references/general-principles.md`
2. `skills/init/references/recon-and-stack-detection.md`
3. `skills/init/references/docs-taxonomy.md`
4. `skills/init/references/project-bootstrap.md`
5. `skills/init/references/claude-hook-bootstrap.md`
6. `skills/init/references/output-files.md`

如果用户显式传入 `--experiment`，再读取：

7. `skills/init/references/experimental-mode.md`
