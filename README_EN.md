...
| `dt:plan-doc-tr`           | Plan-Doc + TDD + Code Review full pipeline: generate plan docs first, then strict TDD execution, then auto code review |
