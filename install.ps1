...
$CommonSkills = @("init", "study", "push", "update-remote-plugins", "code-note", "to-public-cloudflare", "plan-doc", "plan-doc-tr", "project-skills", "work-report")
...
function Get-CategoryDesc($cat) {
    switch ($cat) {
        "common"  { "Common tools (dt:init, dt:study, dt:push, dt:update-remote-plugins, dt:code-note, dt:to-public-cloudflare, dt:plan-doc, dt:plan-doc-tr, dt:project-skills, dt:work-report)" }
